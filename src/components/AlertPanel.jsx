...
function getPrediction() {
  ...
  if (isWeekend) {
    return {
      ...
      futureColor: '#4ade80',
      futureLevel: 25,
      advice: 'Weekend traffic — roads clearing soon',
      adviceIcon: '😊'
    }
  }
  ...
  if (hour >= 8 && hour <= 10) {
    return {
      ...
      futureColor: '#c1121f',
      futureLevel: 95,
      advice: 'Peak morning rush — avoid NH-48',
      adviceIcon: '⚠️'
    }
  }
  ...
  if (hour >= 11 && hour <= 13) {
    return {
      ...
      futureColor: '#4ade80',
      futureLevel: 30,
      advice: 'Traffic easing — good time to travel',
      adviceIcon: '✅'
    }
  }
  ...
  if (hour >= 14 && hour <= 16) {
    return {
      ...
      futureColor: '#f4a261',
      futureLevel: 60,
      advice: 'Evening rush approaching in 1 hour',
      adviceIcon: '⏰'
    }
  }
  ...
  if (hour >= 17 && hour <= 20) {
    return {
      ...
      futureColor: '#e63946',
      futureLevel: 75,
      advice: 'Peak evening rush — use alternate routes',
      adviceIcon: '🚨'
    }
  }
  ...
  return {
    ...
    futureColor: '#4ade80',
    futureLevel: 10,
    advice: 'Roads are clear — safe to travel',
    adviceIcon: '🌙'
  }
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <PredictionBar
          label={`Now — ${prediction.current}`}
          level={prediction.currentLevel}
          color={prediction.currentColor}
        />
        <PredictionBar
          label={`In 20 min — ${prediction.future}`}
          level={prediction.futureLevel}
          color={prediction.futureColor}
        />
